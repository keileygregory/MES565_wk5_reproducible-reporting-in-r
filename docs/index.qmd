...
Click the `⬆Push` button in the top right corner of the Git window pane *([optional]{.underline}: can `⬇Pull` too just to check local branch is up to date with remote)*.
